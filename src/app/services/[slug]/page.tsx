// F:\hamza\portfolio\src\app\services\[slug]\page.tsx
...
async function getService(slug: string): Promise<(PopulatedService & { relatedServices: RelatedService[] }) | null> {
  const service = await client.fetch<(PopulatedService & { relatedServices: RelatedService[] }) | null>(
